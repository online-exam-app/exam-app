            ...
            <div class="navbar-brand-box">
              <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                  <!-- <img
                    src="
                    {{ asset('backend/assets/images/logo-sm.png') }}"
                    alt="logo-sm"
                    height="22"
                  /> -->
                  <h3>Exam App</h3>
              ...
              <!-- <a href="index.html" class="logo logo-light">
                ...
                <h3 class="text-white mt-4">Exam App</h3>
              </a>
            </div>
          ...
          <div class="d-flex">
                ...
                <div data-simplebar style="max-height: 230px">
                  ...
                  <a href="" class="text-reset notification-item">
                    <div class="d-flex">
                      <img
                        src="
                    {{ asset('backend/assets/images/users/avatar-3.jpg') }}"
                  ...
                  <a href="" class="text-reset notification-item">
                    <div class="d-flex">
                      <img
                        src="
                    {{ asset('backend/assets/images/users/avatar-4.jpg') }}"
                        class="me-3 rounded-circle avatar-xs"
                        alt="user-pic"
                      />
                      <div class="flex-1">
            ...
            <div class="dropdown d-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item text-danger" href="{{ route('profile.destroy') }}"
                  ><i
